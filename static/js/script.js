$(document).on("ready", function() {
  ...
  //   Extra Info
  let i = 0;
  $("#submit-extra").hide(); //final submit button
  $("#block1").hide();
  $("#block2").hide();
  $("#block3").hide();
  $("#next").click(function(e) {
    let hideBlock = "#block" + i;
    i = i + 1;
    let showBlock = "#block" + i;
    switch (i) {
      case 1:
        e.preventDefault();
        $("#subtitle").text("tell more about your skills set");
        break;
      case 2:
        e.preventDefault();
        $("#subtitle").text("tell more about your education");
        break;
      case 3:
        e.preventDefault();
        $("#subtitle").text("tell more about your job history");
        break;
      case 4:
        e.preventDefault();
        $("#next").text('Submit')
